    ...
    steps: [
      {
        title: "4단계로 예측 등록",
        body:
          "1) 섹터와 종목을 고르고 — 2) 1일/1주/1달 중 기간을 고르고 — 3) 슬라이더로 예상 변동률을 정한 뒤 — 4) (선택) 근거를 적습니다.",
      },
      {
        title: "채점 방식",
        body:
          "target date에 실제 종가가 결정되면 자동으로 score = max(0, 100 - |예측 - 실제| × 5) 식으로 채점합니다. ±20pp 오차면 0점, 완벽한 예측이면 100점.",
        tip: "한 종목에 여러 horizon을 동시에 등록할 수 있어요 (1d + 1w + 1m).",
      },
    ],
  },
